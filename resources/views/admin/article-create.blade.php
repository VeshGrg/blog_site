            ...
            <div class="container">
                ...
                @if(isset($article_detail))
                    <form action="{{ route('update', $article_detail->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @else
                    <form action="{{ route('submit-article') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <textarea name="description" id="" rows="5" class="form-control" required placeholder="Enter Description here.">{{ @$article_detail->description }}</textarea>
                        </div>
                    </div>

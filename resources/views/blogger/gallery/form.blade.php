        ...
        <div class="content-header">
            <div class="container">
                ...
                @if(isset($gallery_detail))
                    <form action="{{ route('blogger-update-gallery', $gallery_detail->id) }}" method="POST" enctype="multipart/form-data">
                        @method('patch')

                        @else
                            <form action="{{ route('blogger-add-gallery') }}" method="POST" enctype="multipart/form-data">
                                @endif
                                @csrf
